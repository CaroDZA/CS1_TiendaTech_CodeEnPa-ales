 ...
 * @author samue
 */
public class IniciarSesionS extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(IniciarSesionS.class.getName());

    /**
     * Creates new form IniciarSesionS
     */
    public IniciarSesionS() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new IniciarSesionS().setVisible(true));
    }
